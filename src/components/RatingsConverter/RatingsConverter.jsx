import './RatingsConverter.css'

export function RatingsConverter({ ratings }) {
    if (ratings > 5) return

    const wholeRating = Math.floor(ratings)
    const empty = Math.floor(5 - ratings)

    return (
        <div className="stars">
            {Array.from({ length: wholeRating }, (_, i) => (
