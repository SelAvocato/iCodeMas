import { RatingsConverter } from '../../../components/RatingsConverter/RatingsConverter'
import './HighlightedProduct.css'

export function HighlightedProduct({ chosenFeaturedProduct }) {
    return (
            ...
            <div className="chosen-featured-product-details-container">
                <div className="details">
                    ...
                    <div className="chosen-featured-product-ratings-wrapper">
                        <RatingsConverter ratings={chosenFeaturedProduct.ratings} />
                    </div>
